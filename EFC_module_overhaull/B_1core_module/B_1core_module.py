...
from ..C_Context_balans_module.C_context_balans_module import ContextBalansModule
from ..D_Context_situation_control.D_context_situation_controle import ContextSituationControlModule
from ..E_Primare_secondarie_basicneeds.E_primaire_secondarie_basicneeds import PrimaireSecondaireBasicNeedsModule
from ..F_calculate_core.F_calculate_module import calculate_core
from ..G_failsafe_module.G_failsafe_module import EmergencyModule
from ..A_sentiment_analysis.A_sentiment_analysis import (
    detect_emotion_text,
